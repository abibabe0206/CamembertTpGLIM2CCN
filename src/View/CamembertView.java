...
public class CamembertView extends JComponent implements MouseListener,
    ...
    public CamembertView(CamembertModelInterface m) {
        model = m;
        startingAngle = 0.0;

        // reminder: we don't want the model to have an oberserver: use an adapter
       // ((CamembertModelInterfaceAdaptor)model).addObserver(this);
    ...
    public void update(Observable arg0, Object arg1) {
        // TODO Auto-generated method stub
       // Logger.getLogger("view").info("Update notification received from " + arg0.toString() + " : " + arg1);
        buildGraphics();
        paint(getGraphics());
   ...
   /** public static void main(String[] a) {
        ...
        //
        CamembertModelInterfaceAdaptor model = new CamembertModelInterfaceAdaptor();
         ...
         * JTable Section
            ...
            DynamicJTable modelTable = new DynamicJTable();

            JTable table;
        window.setTitle("Camembert Table");
        //table = new JTable(modelTable);
        this.table = view.getTable();
        window.getContentPane().add(new JScrollPane(table), BorderLayout.EAST);
        ...
        window.getContentPane().add(buttons, BorderLayout.AFTER_LINE_ENDS);
    ...
    public class RemoveAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e){
            ...
            for(int i = selection.length - 1; i < selection.length; i--){
                modelTable.removeItemTable(selection[i]);
            }
        }
    }*/
}